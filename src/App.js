...
import {
  ...
  getRegulations,
  addTags,
  addRegulationButtons,
  sortRegulations,
} from "./helpers/bimuHelper";
...
const App = () => {
  ...
  useEffect(() => {
    ...
    let onLoaded = async (e) => {
      ...
      let propertyFilter1 = new bimU.PropertyFilter(
        "Text",
        "勞安_法規內容",
        null
      );
      ...
      let propertySelector2 = new bimU.PropertySelector(
        "Text",
        "勞安_法規內容"
      );
      let propertySelector3 = new bimU.PropertySelector(
        "Text",
        "勞安_法規編號"
      );
      let propertySelector4 = new bimU.PropertySelector(
        "Text",
        "勞安_法規圖片"
      );
      ...
      viewer.getElementDataByProperty(
        ...
        async (data) => {
          ...
          regulations = sortRegulations(regulations)
  ...
  const addTagsAndButtonsByRegulations = async (
    viewer,
    regulations,
    images
  ) => {
    ...
    viewer.getElementDataByQuery(
      ...
      (data) => {
        ...
        eIdxByRegulation = sortRegulations(eIdxByRegulation);
